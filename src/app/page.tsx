...
import { features, lists, plans, works } from "@/lib/constants";
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm">
        <div className="max-w-[90%] mx-auto px-4 sm:px-6 h-15 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 -ml-1">
            <div className="h-9 w-9 rounded-xl bg-slate-900 flex items-center justify-center text-white shadow-inner">
      ...
      <section className="max-w-[90%] mx-auto px-4 sm:px-6 pt-20 sm:pt-25 md:pt-35  pb-16 text-center">
        <h1 className="text-4xl sm:text-6xl font-black text-slate-900 leading-tight tracking-tighter mb-5 max-w-3xl mx-auto">
          Stop Chasing Payment Mismatches.<br />
          <span className="text-blue-500 sm:text-7xl md:text-6xl">Automate Reconciliation.</span>
        </h1>
      ...
      <section className="border-t border-slate-200 bg-gray-100 text-black">
        <div className="max-w-[90%] mx-auto px-4 sm:px-6 py-14 text-center">
          <Globe className="h-8 w-8 text-slate-600 mx-auto mb-4" />
